...
node 'warp.sec.home.tld' inherits basenode {
	...
	puppet_gitserver::config { 'git1_perldisttemplate': gitgrp => 'git1',projectname => 'My-Distribution'}	
    puppet_gitserver::config { 'git1_depotest': gitgrp => 'git1',projectname => 'depotest'}

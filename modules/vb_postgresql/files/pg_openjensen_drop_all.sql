...
ALTER TABLE tbl_user DROP CONSTRAINT CASCADE e_tbl_user_pk ;
...
ALTER TABLE tbl_program DROP CONSTRAINT CASCADE e_tbl_program_pk ;
...
ALTER TABLE tbl_usertype DROP CONSTRAINT CASCADE e_tbl_usertype_pk ;
